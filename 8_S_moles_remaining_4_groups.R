DT=read.csv("sulfate_moles_remaining.csv",header=T,sep=",",stringsAsFactors=FALSE)
DT
names(DT)
DT[1]
x=1:17
...
#plot raw
plot(x, DT$raw1, type="l", lwd=2, col="blue", ylim=c(0, 3000), xaxs="i", yaxs="i", xlab="Weeks", ylab="Sulfur remaining (mmoles)")
...
#plot 3%
plot(x, DT$X3pcLS1, type="l", lwd=2, col="blue", ylim=c(0,3000), xaxs="i", yaxs="i", xlab="Weeks", ylab="Sulfur remaining (mmoles)")
...
#plot .75 rate
plot(x, DT$X.75R1, type="l", lwd=2, col="blue", ylim=c(0,3000), xaxs="i", yaxs="i", xlab="Weeks", ylab="Sulfur remaining (mmoles)")
...
#plot 1.1 rate
plot(x, DT$X1.1R1, type="l", lwd=2, col="blue", ylim=c(0,3000), xaxs="i", yaxs="i", xlab="Weeks", ylab="Sulfur remaining (mmoles)")
