#this code produces a barplot of Fe release as mg/Kg/week

DT=read.csv("5_Fe_mg.csv",header=T,sep=",",stringsAsFactors=FALSE)
...
myPlot(5,7,8,names=c("3% LS 1","3% LS 2","3% LS 3"))
myPlot(8,10,8,names=c(".75 Rate 1",".75 Rate 2",".75 Rate 3"))
myPlot(11,13,8,names=c("1.1 Rate 1","1.1 Rate 2","1.1 Rate 3"))
mtext("Cumulative Iron Release Over First 25 Weeks", outer = TRUE, cex = 0.9, line=1)
